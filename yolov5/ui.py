...
class YOLOv5GUI:
    def __init__(self, root):
        ...
        self.epoch_slider = ttk.Scale(self.train_frame, from_=1, to=300, orient=tk.HORIZONTAL, variable=self.epochs, length=300)
    ...
    def show_loading_screen(self):
        ...
        self.loading_gif = [tk.PhotoImage(file=gif_path, format='gif -index %i' % i) for i in range(30)]  # assuming 30 frames
