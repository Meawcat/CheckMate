...
def main():
    ...
    for iteration, (image_st, image_ae), image_penalty in zip(
        ...
        # if iteration % 1000 == 0:
        #     torch.save(teacher.state_dict(), os.path.join(train_output_dir,
        #                                      'teacher_tmp'+str(iteration)+'.pth'))
        #     torch.save(student.state_dict(), os.path.join(train_output_dir,
        #                                      'student_tmp'+str(iteration)+'.pth'))
        #     torch.save(autoencoder.state_dict(), os.path.join(train_output_dir,
        #                                          'autoencoder_tmp'+str(iteration)+'.pth'))
